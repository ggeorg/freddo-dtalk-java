...
import freddo.jmdns.impl.JmmDNSImpl;
...
public interface JmmDNS extends Closeable {
     ...
     * @see freddo.jmdns.JmDNS#getName()
     */
     ...
     * @see freddo.jmdns.JmDNS#getHostName()
     */
     ...
     * @see freddo.jmdns.JmDNS#getInterface()
     */
     ...
     * @see freddo.jmdns.JmDNS#getServiceInfo(java.lang.String, java.lang.String)
     */
     ...
     * @return list of service info. If no service info is found the list is empty.
     * @see freddo.jmdns.JmDNS#getServiceInfo(java.lang.String, java.lang.String, long)
     */
     ...
     * @return list of service info. If no service info is found the list is empty.
     * @see freddo.jmdns.JmDNS#getServiceInfo(java.lang.String, java.lang.String, boolean)
     */
     ...
     *            if <code>true</code> ServiceListener.resolveService will be called whenever new new information is received.
     * @return list of service info. If no service info is found the list is empty.
     * @see freddo.jmdns.JmDNS#getServiceInfo(java.lang.String, java.lang.String, boolean, long)
     */
     ...
     * @param name
     *            unqualified service name, such as <code>foobar</code> .
     * @see freddo.jmdns.JmDNS#requestServiceInfo(java.lang.String, java.lang.String)
     */
     ...
     * @param persistent
     *            if <code>true</code> ServiceListener.resolveService will be called whenever new new information is received.
     * @see freddo.jmdns.JmDNS#requestServiceInfo(java.lang.String, java.lang.String, boolean)
     */
     ...
     * @see freddo.jmdns.JmDNS#requestServiceInfo(java.lang.String, java.lang.String, long)
     */
     ...
     * @param timeout
     *            timeout in milliseconds
     * @see freddo.jmdns.JmDNS#requestServiceInfo(java.lang.String, java.lang.String, boolean, long)
     */
     ...
     * @exception IOException
     * @see freddo.jmdns.JmDNS#addServiceTypeListener(freddo.jmdns.ServiceTypeListener)
     */
     ...
     * @param listener
     *            listener for service types
     * @see freddo.jmdns.JmDNS#removeServiceTypeListener(freddo.jmdns.ServiceTypeListener)
     */
     ...
     * @see freddo.jmdns.JmDNS#addServiceListener(java.lang.String, freddo.jmdns.ServiceListener)
     */
     ...
     * @param listener
     *            listener for service updates
     * @see freddo.jmdns.JmDNS#removeServiceListener(java.lang.String, freddo.jmdns.ServiceListener)
     */
     ...
     * @exception IOException
     * @see freddo.jmdns.JmDNS#registerService(freddo.jmdns.ServiceInfo)
     */
     ...
     * @see freddo.jmdns.JmDNS#unregisterService(freddo.jmdns.ServiceInfo)
     */
     ...
     *
     * @see freddo.jmdns.JmDNS#unregisterAllServices()
     */
     ...
     * @param type
     *            full qualified service type, such as <code>_http._tcp.local.</code>.
     * @see freddo.jmdns.JmDNS#registerServiceType(java.lang.String)
     */
     ...
     * @see freddo.jmdns.JmDNS#list(java.lang.String)
     */
     ...
     * @return An array of service instance.
     * @see freddo.jmdns.JmDNS#list(java.lang.String, long)
     */
     ...
     * @see freddo.jmdns.JmDNS#listBySubtype(java.lang.String)
     */
     ...
     *            timeout in milliseconds. Typical timeout should be 6s.
     * @return A dictionary of service info by subtypes.
     * @see freddo.jmdns.JmDNS#listBySubtype(java.lang.String, long)
     */
