...
package freddo.jmdns.impl.tasks.state;
...
import freddo.jmdns.impl.DNSOutgoing;
import freddo.jmdns.impl.DNSStatefulObject;
import freddo.jmdns.impl.JmDNSImpl;
import freddo.jmdns.impl.ServiceInfoImpl;
...
/**
 * This is the root class for all state tasks. These tasks work with objects that implements the {@link freddo.jmdns.impl.DNSStatefulObject} interface and therefore participate in the state machine.
 * 
